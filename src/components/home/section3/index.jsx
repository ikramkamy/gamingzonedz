...
<div className="flex max-sm:flex-col justify-center items-center w-full relative max-sm:bg-bgSection33 max-sm:h-150vh
  max-sm:bg-contain max-sm:bg-center py-20 max-sm:bg-no-repeat max-sm:bg-[length:1000px_150vh]">
<svg 

className='absolute  top-0 w-full max-sm:invisible'
...
<div className="flex flex-col   w-1/2 max-sm:w-full  justify-center items-end z-10 h-fit ">
    <h1 className='text-[67px] uppercase text-redPrimary  w-2/3 max-sm:text-[28px] max-sm:text-center max-sm:w-full min-h-[150px]'>{textAnimated}</h1>
    ...
    <h3 className="text-[20px] w-2/3 max-sm:w-full max-sm:pl-2 max-sm:text-[14px]  max-sm:w-[95%]">
...
<p className="text-[20px] max-sm:text-[14px] max-sm:w-[80%] ">
    <b>Price</b><br/>
...
<div className='z-10 w-1/2 flex justify-start max-sm:hidden
 items-center'>
