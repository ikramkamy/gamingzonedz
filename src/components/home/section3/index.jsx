...
<div className="flex flex-col   w-1/2 justify-center items-end z-10 py-[10%]">
    <h1 className='text-[67px] uppercase text-redPrimary  w-2/3'>Why Go Prebuilt ?</h1>
    <h3 className="text-[20px] w-2/3">These gaming PCs aren't just built by experts, they're designed by them too! Gaming zone Prebuilt gaming PCs are made with budget and experience in mind.</h3>
<div className="flex justify-between items-center  mb-3 mt-10 w-2/3">
<svg 
className='mr-4'
...
<div className="flex justify-between items-center mb-3 w-2/3">
<svg 
className='mr-4'
...
<div className='z-10 w-1/2 flex justify-start
 items-center'><img src={image} alt="gaming zone Rebuilt computer" /></div>
</div>
